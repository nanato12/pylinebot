...
def receive_message(bot:LINE, event:Any)->None:
    ...
    if message_type == 'sticker':
        ...
        if message_text == 'てきすと':
            ...
            bot.reply_sticker_message(sticker_data, sticker_data, sticker_data, sticker_data, sticker_data)

        elif message_text == 'ふれっくす':
            flex_data = {
                'content': get_flex('test'),
            ...
            bot.reply_flex_message(flex_data, flex_data, flex_data, flex_data, flex_data)
